        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-gray-400 text-xs tracking-wider">{tx.password}</label>
              <Link href="/forgot-password" className="text-gray-500 text-xs hover:text-white transition">
